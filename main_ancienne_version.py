...
def show_home():
    ...
    def render():
        ...
        glass_panel(base, (0, 0, 236, h), radius=0, tint=(5, 12, 25), alpha=125, blur=4,
                    border=(103, 232, 249, 85))
        ...
        for i in range(4):
            ...
            glass_panel(base, (x, card_y, x + card_w, card_y + card_h), radius=18,
                        tint=(7, 18, 34), alpha=105, blur=3,
                        border=(103, 232, 249, 115))

        lower_y = 232
        lower_bottom = h - 24
        lower_w = (right - left - gap) * 0.64
        glass_panel(base, (left, lower_y, left + lower_w, lower_bottom), radius=20,
                    tint=(7, 18, 34), alpha=112, blur=4,
                    border=(103, 232, 249, 115))
        glass_panel(base, (left + lower_w + gap, lower_y, right, lower_bottom), radius=20,
                    tint=(7, 18, 34), alpha=112, blur=4,
                    border=(167, 139, 250, 120))

        # Zone de titre : petit voile pour garantir la lisibilité sans masquer la photo.
        glass_panel(base, (left - 8, 18, min(right, left + 520), 91), radius=14,
                    tint=(4, 12, 24), alpha=58, blur=2,
                    border=(103, 232, 249, 45))
        ...
        canvas.create_text(left, 43, text="Bienvenue sur ", anchor="w", fill=TEXT,
                           font=("Arial", 28, "bold"))
        canvas.create_text(left + 245, 43, text="PC Helper", anchor="w", fill="#38D5FF",
                           font=("Arial", 28, "bold"))
        ...
        bh = 52
        canvas.create_rectangle(bx, by, bx + bw, by + bh, radius=0, fill="#0D8FEA",
        ...
        bx2 = bx + bw + 18
        canvas.create_rectangle(bx2, by, bx2 + bw, by + bh, radius=0, fill="#8F63F4",
